...
from app.api import activation, admin, admin_health, admin_rate_limits, ai, analytics, auth, billing, leverage, master_source, plan_discounts, public, user, ws
...
http_router.include_router(admin_rate_limits.router)
